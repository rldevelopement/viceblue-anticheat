...
AC.VehicleProtection = true
AC.CommandsProtection = true
AC.EventProtection = true
AC.EventsFiltred = true

AC.TriggerServer = "::{korioz#0110}::"
AC.Prefix = "ViceAC"
AC.CommandsCleanCache = "cleanCache" 
AC.DiscordWebhook = "https://discord.com/api/webhooks/886359730543554591/ritjkXqy158mI3_r_bg6t4DTjhZhKMQl3j-YNEjNFKPjkhJ6piWa1hz5IEzYvyp5cdiE"
AC.KickMessage = "🌊 ViceBlue : Le Cheat n'est pas autorisé !" -- Mesage de Kick

AC.BlacklistedCommands = {
    'pk',
    'haha',
    'lol',
    'xddd',
